...
ROOM_Ln_TARGET_RENTAL_KEYS = [
    ["quarter", "name"],
    ["corporation", "name"],
    ["dwellingType", "localizedName"],
    ["sleepingRoom", "amountOfRooms"],
    ["sleepingRoom", "naam"],
    ["kitchen", "localizedName"],
    ["floor", "verdieping"],
    ["woningsoort", "localizedNaam"],
]
...
KAMERNET_SEARCH_PL = {
    "location": {"name": "Leiden", "cityName": "Leiden"},
    "radiusId": 4,
    "listingTypeIds": [],
    "maxRentalPriceId": 33,
    "surfaceMinimumId": 2,
...
KAMERNET_FURNISHING_MAP = {1: "uncarpeted", 2: "unfurnished", 3: "", 4: "furnished"}

KAMERNET_LISTING_TYPE_MAP = {1: "room", 2: "apartment", 3: "", 4: "studio"}
